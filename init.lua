...
-- See `:help mapleader`
-- The leader key is effectively a namespace for custom keymaps.
...
-- Diabling arrow keys in insert mode.
...
-- Turn on soft-wrap
-- vim.api.nvim_create_autocmd({ 'BufReadPost' }, {
--   desc = 'Turn on soft-wrap',
--   pattern = { '*' },
--   callback = function()
--     vim.api.nvim_exec2('silent! normal! [ow', { output = false })
--   end,
-- })
...
require('lazy').setup({
        ...
        handlers = {
          ...
          jdtls = function()
            ...
            require('lspconfig').jdtls.setup {
              -- Your custom nvim-java config goes here.
            }
          end,
        },
      }
  ...
  { 'ANTALLIS/todo-comments.nvim', event = 'VimEnter', dependencies = { 'nvim-lua/plenary.nvim' }, opts = { signs = false } },
